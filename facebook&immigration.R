...
#We retrieved the data from Matteo Salvini's facebook page
...
#we see if there is any correlation between days went from election and his facebook's likes
...
#This last model is the one we prefer, let's analyze it
...
###LET'S MAKE AN ANALYSIS ON HOW THE SHARES, LIKES AND COMMENTS CHANGED
Salvini <- read.csv2("Salvini_feed.csv")
...
#let's delete words with less then three letters, chunks of code and italian stop words
...
#Let's delete words that have "strange accents" .csv files don't read properly.
...
###### NOW LET'S FOCUS ON IMMIGRANT ANALYSIS, WE ANALYZE DATA FROM 
#http://nesstar.ess.nsd.uib.no/webview/index.jsp?v=2&submode=variable&study=http%3A%2F%2F129.177.90.83%3A-1%2Fobj%2FfStudy%2FESS7e02.1&gs=undefined&variable=http%3A%2F%2F129.177.90.83%3A80%2Fobj%2FfVariable%2FESS7e02.1_V177&mode=documentation&top=yes
#http://data.europa.eu/euodp/en/data/dataset/S2169_88_2_469_ENG
